                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td valign="middle" align="left" style="width:75%">
                                                                        <img style="display: inline-block; position: relative; max-width: 100%" src="https://technofra.com/assets/image/technofra_logo_White.png" width="60%" height="60%" border="0">
                                                                    </td>
...
// ifeq akwm dysq exf- app password
// Admin Email Setup
$mail = new PHPMailer();
$mail->IsSMTP();
